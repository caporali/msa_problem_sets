...
# Exercise 2
Potentially some introductory comment on the data ? 
...
plot(LD2~LD1, data=pred$x, asp=1, pch=16,col=digit.col)
```
...
#cat(round(((1-conf_mat_cv$`Overall Accuracy`) - (1 - conf_mat$`Overall Accuracy`))/ (1-conf_mat_cv$`Overall Accuracy`) *100, 3), sep = '', '%')
```
