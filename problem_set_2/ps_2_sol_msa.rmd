...
\begin{center}
	\begin{tabular}{ c | c c c c c c c c c c }
		...
		\hline
		\multirow{2}{4em}{\texttt{color}} & \small{`r paste(lookup[1])`} & \small{`r paste(lookup[2])`} & \small{`r paste(lookup[3])`} & \small{`r paste(lookup[4])`} & \small{`r paste(lookup[5])`} & \small{`r paste(lookup[6])`} & \small{`r paste(lookup[7])`} & \small{`r paste(lookup[8])`} & \small{`r paste(lookup[9])`} & \small{`r paste(lookup[10])`} \\ 
		& \textcolor{`r paste(lookup[1])`}{$\bullet$} & \textcolor{`r paste(lookup[2])`}{$\bullet$} & \textcolor{`r paste(lookup[3])`}{$\bullet$} & \textcolor{`r paste(lookup[4])`}{$\bullet$} & \textcolor{`r paste(lookup[5])`}{$\bullet$} & \textcolor{`r paste(lookup[6])`}{$\bullet$} & \textcolor{`r paste(lookup[7])`}{$\bullet$} & \textcolor{`r paste(lookup[8])`}{$\bullet$} & \textcolor{`r paste(lookup[9])`}{$\bullet$} & \textcolor{`r paste(lookup[10])`}{$\bullet$} \\ 
	\end{tabular}
\end{center}
