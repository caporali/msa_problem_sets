...
<!-- One remark from Fra Capo: these two states were the last ones to join the federation. Of course we don't claim this to be causal. Nonetheless, the absense of contiguity with the other states definitely reduces the net flow with other states therefore reducing homogenizing factors. -->
...
The first three principal components explain the $83.3\%$ of the variability of the data, and if we add a fourth components we arrive near to the $95\%$, which exceeds our requirements.
...
In order to identify the ones which capture most of the variance of the original variables, we want to identify the ones that are sized above average. As the original data was previously standardized,  this means to look for eigenvalues greater than $1$. 
